<%--
  ...
  Date: 2016/8/1
  Time: 11:09
  describtion:后台管理--【用户管理】微信自行发布详情页面
...
<script type="text/javascript">
  ...
  function loadUser() {
    var obj = {};
    obj.action = 'show_passenger_info';
    obj.size = size;
  ...
  function deleteSingle(item) {
    ...
    obj.order_id = id;
    obj.source = source;
    operation.operation_ajax('/api/db/passenger/departure', obj, loadUser);
  }
  //添加用户数据
  ...
  function insertWXUserMessage() {
    for (var i = 0; i < global_data.data.length; i++) {
      ...
      var id = global_data.data[i].user_id;//id
