<%--
  ...
  Date: 2016/8/3
  Time: 11:09
  describtion:后台管理--【拼车信息会】车主发布信息列表
...
<script type="text/javascript">
    ...
    var click_type;
    var user_id;
    var action_url = "/api/db/departure";
    ...
    function insertUserMessage() {
        for (var i = 0; i < global_data.data.length; i++) {
            ...
            addUserDisplay(price,driving_name, info_status, insert_time, mobile, departure_city, destination_city,
    ...
    //添加用户列表
    function addUserDisplay(price,driving_name, info_status, insert_time, mobile, departure_city, destination_city,
                            description, inits_seats, car_brand, id, publish_time, departure, destination) {
    ...
    function addManagerStyle(obj) {
        ...
        var driver_type_price = li.find('.driver_type_price').text();
        ...
        $('.find_price_span').text(driver_type_price);
    ...
    function addCopyMessageStyle() {
        $('#message_container').append('<span style="display: inline-block;padding: 6px;">【来回拼车】牵起你生活中的每一次来回</span>'+
                ...
                '<div class="clear"></div>' +
                '</div>' +
                '<div class="input_list find_price">' +
                '<div class="input_list_left">' +
                '<span>【价格】</span>' +
                '</div>' +
                '<div class="input_list_right">' +
                '<span class="find_price_span"></span>' +
                '</div>' +
                '<div class="clear"></div>' +
                '</div>' +
    ...
    <div id="ui_right">
        ...
        <div class="userManage_container">
            ...
            <div class="sub_title_bar">
                ...
                <a href="/db/driver/departure" class="add_span"><span
