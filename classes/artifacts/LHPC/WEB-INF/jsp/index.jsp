...
<script type="text/javascript">
    ...
    function insertUserMessage(){
        ...
        for (var i = 0; i < global_data.data.length; i++){
            ...
            addUserDisplay(is_validated_passenger,create_time,idsn,is_validated_car,mobile,name,id,last_logined_time);
        }
    }
    //添加用户列表
    function addUserDisplay(is_validated_passenger,create_time,idsn,is_validated_car,mobile,name,id,last_logined_time) {
        $(".userManage_container_ul").append('<li class="user_manage_container_li" user_id='+id+' is_validated_car='+is_validated_car+' is_validated_passenger='+is_validated_passenger+' onmouseleave="hideDeleteTip(this)">' +
                ...
                '<span class="userManage_span">192.168.1.1</span>' +
