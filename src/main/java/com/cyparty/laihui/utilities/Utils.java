...
public class Utils {
    public static void main(String[] args) {
        ...
        System.out.println(encode("MD5", "admin123456"));
    }
    ...
    public static String sendCodeMessage(String mobile){
        ...
        boolean send_isSuccess= SendSMSUtil.sendSMS(mobile, "push", 18365, code);
        if(!send_isSuccess){
            code=null;
        }else {
            code=rand;
    ...
    public static String getRandomToken(int current_id){
        String result="";
        result=Utils.getTimestamp()+random(8)+current_id;
        return result;
    }
