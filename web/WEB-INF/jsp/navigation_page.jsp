...
<script type="text/javascript">
  ...
  var global_id;
  var action_url = '/api/navigation_page/manage';
  var click_type=1;
  //请求列表数据
  function load(){
  ...
  function ShopsListStyle(image_link,image_url,id, content, title, seq, subtitle) {
    $('.not_find_message').before('<li class="question_list question_list_message_box_right" id='+id+'>'+
            ...
            '<span class="article_tittle_box_span">导航排序</span>'+
  ...
  function addManagerStyle(){
    ...
    $('.slide_container_top').find('.slide_container_top_title').text('添加导航图');
  ...
  function showEditTip(obj){
    ...
    $('.ad_seq').text(img_seq);
    $('.slide_container').animate({"top":"12%","opacity":"1"},300);
    $('.slide_container_top').find('.slide_container_top_title').text('编辑导航图');
  ...
  function addAD() {
    ...
    $.ajax({
      type: "post",
      url: "/api/navigation_page/manage",
      data: data,
      processData: false,
      contentType: false,
  ...
  <div id="ui_right">
    ...
    <div class="question_list_container">
      <div class="sub_title_bar">
        ...
        <span class="add_span" onclick="addManagerStyle()"><span class="add_classify">+</span>新建导航图</span>
        <div class="clear"></div>
      </div>
  ...
  <div class="slide_container">
    <form method="post" id="upload_form" accept-charset="utf-8" onsubmit="return false" enctype="multipart/form-data" action="/api/goods?action=create">
      <div class="slide_container_top">
        <span class="slide_container_top_title">添加导航</span>
