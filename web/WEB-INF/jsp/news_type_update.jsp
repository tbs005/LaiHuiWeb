...
<div class="ui_body">
  ...
  <form:form modelAttribute="news" id="newsForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/type/update" method="post">
    <input type="hidden" id="typeId" name="typeId" value="${news.typeId}">
    <div class="news_title"> <div>编辑类型</div></div>
      <ul>
        <li>图片:<input type="file" name="img" id="img" onchange="previewImage(this)" ></li>
        <div id="preview" >
          <img id="imghead" src="${news.logo}" width=100 height=100 border=0>
        </div>
        <li>类型名称:<input type="text" name="typeName" id="title" value="${news.typeName}"></li>
        <li>
