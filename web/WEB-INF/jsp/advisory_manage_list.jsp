...
//        搜索重置page
    ...
    function insertUserMessage() {
        ...
        /*//配置获取图片名称
         ...
         // 上传图片
         editor.config.uploadImgUrl = '/advisory/manage/upload';
         // 配置自定义参数
    ...
    function checkInputMessage() {
        if ($('#e_title').val() == "") {
            showErrorTips('请输入资讯标题')
        } else if ($('#e_sub_title').val() == "") {
            showErrorTips('请输入资讯副标题')
        } else {
            addAD();
        }
    }
    ...
    function addManagerStyle() {
        ...
        click_type = 0;
        $('.slide_container').animate({"top": "12%", "opacity": "1"}, 300);
        $('.slide_container_top').find('.slide_container_top_title').text('添加资讯');
    ...
    function addUserDisplay(title, sub_title, create_date, id, content) {
        $(".userManage_container_ul").append('<li class="user_manage_container_li" id=' + id + ' onmouseleave="hideDeleteTip(this)">' +
            '<input type="hidden" id="advisoryId" value="' + id + '">' +
            '<span class="userManage_span manage_departure" id="title">' + title + '</span>' +
            '<span class="userManage_span manage_destination" id="sub_title">' + sub_title + '</span>' +
            '<span class="userManage_span manage_driving_length" id="content">' + content + '</span>' +
    ...
    <div id="ui_right">
        ...
        <div class="userManage_container">
            ...
            <div class="sub_title_bar">
                ...
                <a href="javascript:void(0)" class="add_span" onclick="addManagerStyle()"><span
                        class="add_classify">+</span>新建资讯</a>
                <div class="page_box">
            ...
            <ul class="userManage_container_ul">
                <li class="userManage_container_li_top">
                    ...
                    <span class="userManage_span">内容预览</span>
        ...
        <div class="slide_container">
            <form method="post" id="upload_form" accept-charset="utf-8" onsubmit="return false"
                  action="/advisory/manage?action=create">
                <div class="slide_container_top">
                    <span class="slide_container_top_title">添加资讯</span>
                ...
                <div class="slide_container_mid">
                    <div class="input_list">
                        ...
                        <input type="text" name="title" placeholder="资讯标题" id="e_title"
                               class="input_style route_start"/>
                    </div>
                    <div class="input_list">
                        <img src="/resource/images/pc_icon_beihzu.png"/>
                        <input type="text" name="sub_title" placeholder="资讯副标题" id="e_sub_title"
                               class="input_style route_sub"/>
                    </div>
                    <div class="input_list">
                        <img src="/resource/images/pc_icon_beihzu.png"/>
                        <%--<script id="editor" type="text/plain" style="width:1024px;height:500px;"></script>
                        <jsp:include page="ueditorUpload.jsp" flush="true" />--%>
                    </div style="width: 90%">
