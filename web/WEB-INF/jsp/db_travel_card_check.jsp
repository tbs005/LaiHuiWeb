    ...
    $.ajax({
        ...
        success:function(data){
            if(data.result.msg == undefined){
                ...
                $('.car_license_number').html(data.result.travelCard.car_license_number)
                $('.car_color').html(data.result.travelCard.car_color)
                $('.car_type').html(data.result.travelCard.car_type)
                $('.registration_date').html(data.result.travelCard.registration_date)
                $('.vehicle_owner_name').html(data.result.travelCard.vehicle_owner_name)
                $('.travel_license_photo').children('img').attr("src",data.result.travelCard.photo_url);
                var oid = data.result.travelCard.id;
                agree(oid);
                disagree(oid);
            }else{
