...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $('.app_driver_departure_count').addClass('active_li');
    // 绑定键盘按下事件
  ...
  var click_type;
  var user_id;
  var action_url = "/api/wx_user/cumulate";
  ...
  function loadWXUser(){
    var obj={};
    obj.action='app_driver_departure_count';
  ...
  function loadList() {
    ...
    obj.flag = flag;
    obj.source = source;
    operation.operation_ajax('/api/db/departure', obj, sendMessage);
  }
...
//      var user_avatar = global_data.data[i].user_avatar;//微信头像
      var user_name = global_data.data[i].driving_name;//微信昵称
...
//      }
      ...
      addUserDisplay(driving_name, info_status, insert_time, mobile, departure_city, destination_city,
              description, inits_seats, car_brand, id, publish_time, departure, destination,user_name);
