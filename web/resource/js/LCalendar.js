        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalendar_title">选择注册日期</div>' +
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalendar_title">选择车牌型号</div>' +
...
window.DriverDate = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.keys = params.keys;
            this.status = params.status;//添加座位状态
            this.type = params.type||1;
            switch (this.type) {
                case 1:
                case 2:
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                    ...
                    _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                        '<div class="area_btn_box">' +
                        '<div class="area_btn larea_cancel">取消</div>' +
                        '<div class="date_btn lcalendar_title">出行时间</div>' +
                        '<div class="area_btn larea_finish">确定</div>' +
                        '</div>' +
                        '<div class="area_roll_mask">' +
                        '<div class="area_roll">' +
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                    ...
                    _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                        '<div class="area_btn_box">' +
                        '<div class="area_btn larea_cancel">取消</div>' +
                        '<div class="date_btn lcalendar_title">可用座位</div>' +
                        '<div class="area_btn larea_finish">确定</div>' +
                        '</div>' +
                        '<div class="area_roll_mask">' +
                        '<div class="area_roll">' +
                        '<div class="set_container1">' +
                        '<div class="gear area_province" data-areatype="area_province">' +
                        '<div class="tooth" ref="1"><span>1个</span></div>' +
                        '</div>' +
                        '</div>' +
                        '<div class="set_container2">' +
                        '<div class="gear area_city" data-areatype="area_city"><div class="tooth" ref="2">2个</div></div>' +
                        '</div>' +
                        '<div class="set_container3">' +
                        '<div class="gear area_city" data-areatype="area_city"><div class="tooth" ref="3">3个</div></div>' +
                        '</div>' +
                        '<div class="set_container4">' +
                        '<div class="gear area_city" data-areatype="area_city"><div class="tooth" ref="4">4个</div></div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                    ...
                    document.body.appendChild(_self.gearArea);
                    var larea_finish = _self.gearArea.querySelector(".larea_finish");
                    var set_container1 = _self.gearArea.querySelector(".set_container1");
                    var set_container2 = _self.gearArea.querySelector(".set_container2");
                    var set_container3 = _self.gearArea.querySelector(".set_container3");
                    var set_container4 = _self.gearArea.querySelector(".set_container4");
                    larea_finish.addEventListener('touchstart', function(e) {
                        _self.close(e);
                    });
                    var larea_cancel = _self.gearArea.querySelector(".larea_cancel");
                    ...
                    set_container1.addEventListener('touchstart', function(e) {
                        _self.close(e);
                        demo.value="1个可用座位"
                    });
                    set_container2.addEventListener('touchstart', function(e) {
                        _self.close(e);
                        demo.value="2个可用座位"
                    });
                    set_container3.addEventListener('touchstart', function(e) {
                        _self.close(e);
                        demo.value="3个可用座位"
                    });
                    set_container4.addEventListener('touchstart', function(e) {
                        _self.close(e);
                        demo.value="4个可用座位"
                    });
                }
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    '<div class="area_btn_box">' +
                    '<div class="area_btn larea_cancel">取消</div>' +
                    '<div class="date_btn lcalendar_title">选择起止地点</div>' +
                    '<div class="area_btn larea_finish">确定</div>' +
                    '</div>' +
                    '<div class="area_roll_mask">' +
                    '<div class="area_roll">' +
